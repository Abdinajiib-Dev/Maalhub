...
import { Send, Loader2, MessageSquare, Search, User } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-80px)] flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Communicate directly with your connections.</p>
      </div>

      <div className="flex-1 bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden flex h-full min-h-[500px]">
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900">{otherUser?.full_name || 'Unknown User'}</h3>
                      ...
                      return (
                        <div key={msg.id || index} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                          <div className={`max-w-[70%] rounded-2xl px-5 py-3 ${
                            ...
                            <span className={`text-[10px] block mt-1 text-right ${isMe ? 'text-primary-foreground/70' : 'text-gray-400'}`}>
              ...
              <div className="p-4 bg-white border-t border-gray-200">
                <form onSubmit={handleSendMessage} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-gray-50 border border-gray-200 rounded-full px-5 py-3 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                  />
                  <button 
                    type="submit"
                    disabled={isSending || !messageText.trim()}
                    className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center hover:bg-secondary transition-colors disabled:opacity-50 flex-shrink-0 shadow-sm"
                  >
