  ...
  return (
    <div className="px-8 py-8 w-full max-w-[1200px] mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2 text-sm">Manage your personal and professional information.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
            <div className="w-32 h-32 rounded-full bg-[#FAF0E6] border-4 border-white shadow-md flex items-center justify-center text-primary text-4xl font-bold mb-4 overflow-hidden relative group cursor-pointer">
            ...
            <button className="w-full bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 font-medium text-sm py-2 rounded-lg transition-colors">
              Edit Profile
            </button>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900 font-medium">{profile.city}, {profile.country}</p>
                </div>
              </div>
              ...
              {isEntrepreneur ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-medium text-gray-500 mb-1">Startup Name</p>
                      <p className="text-sm text-gray-900 font-medium">{roleDetails.startup_company_name}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900 font-medium">{roleDetails.industry}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-medium text-gray-500 mb-1">Startup Stage</p>
                      <p className="text-sm text-gray-900 font-medium">{roleDetails.startup_stage}</p>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-medium text-gray-500 mb-1">Investor Type</p>
                      <p className="text-sm text-gray-900 font-medium">{roleDetails.investor_type}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-medium text-gray-500 mb-1">Investment Range</p>
                      <p className="text-sm text-gray-900 font-medium">
